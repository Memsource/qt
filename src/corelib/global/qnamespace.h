...
public:
    ...
    enum Key {
        ...
        Key_Ampersand = 0x26,
        Key_Apostrophe = 0x27,
        Key_LeftDoubleAngleQuote = 0xAB,
        Key_RightDoubleAngleQuote = 0xBB,
        Key_LeftSingleQuote = 0x2018,
        Key_RightSingleQuote = 0x2019,
        Key_SingleLow9Quote = 0x201A,
        Key_SingleHighReversed9Quote = 0x201B,
        Key_LeftDoubleQuote = 0x201C,
        Key_RightDoubleQuote = 0x201D,
        Key_DoubleLow9Quote = 0x201E,
        Key_DoubleHighReversed9Quote = 0x201F,
        Key_LeftSingleAngleQuote = 0x2039,
        Key_RightSingleAngleQuote = 0x203A,
        Key_LeftCornerBracket = 0x300C,
        Key_RightCornerBracket = 0x300D,
        Key_LeftWhiteCornerBracket = 0x300E,
        Key_RightWhiteCornerBracket = 0x300F,
        Key_ReversedDoublePrimeQuote = 0x301D,
        Key_DoublePrimeQuote = 0x301E,
        Key_LowDoublePrimeQuote = 0x301F,
        Key_PresentFormVerticalLeftCornerBracket = 0xFE41,
        Key_PresentFormVerticalRightCornerBracket = 0xFE42,
        Key_PresentFormVerticalLeftCornerWhiteBracket = 0xFE43,
        Key_PresentFormVerticalRightCornerWhiteBracket = 0xFE44,
        Key_FullWidthQuote = 0xFF02,
        Key_FullWidthApostrophe = 0xFF07,
        Key_HalfWidthLeftCornerBracket = 0xFF62,
        Key_HalfWidthRightCornerBracket = 0xFF63,
        Key_ParenLeft = 0x28,
        Key_ParenRight = 0x29,
        Key_Asterisk = 0x2a,
        Key_Plus = 0x2b,
